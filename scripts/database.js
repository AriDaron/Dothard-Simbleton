...
const NewYork = (businessObj) => {
    if (businessObj.addressStateCode === "NY") {
        return true
    }
    return false
}
export const NyStates = businesses.filter(business => business.addressStateCode === "NY")

export const getManufacturedBusinesses = businesses.filter(business => business.companyIndustry === "Manufacturing")

export const getPurchasingAgent = () => {
